...
temps_A_abdo = uicontrol('Parent',psignalAabdo,'Style','text','FontSize',8,'String','temps (s)','Position',[735 14 60 25]);
...
listedossier = uicontrol('Parent',prepertoire,'Style','listbox','String','fichier','Position',[23 160 300 240],'Callback',{@filelist_callback});
...
OK = uicontrol('Parent',prepertoire,'Style','pushbutton','FontSize',12,'String','OK','Position',[110 120 150 40],'ToolTipString', 'Selectionnez un dossier contenant des fichiers .mat sortant du Biopac','Callback',{@afficherGraph});
...
precedent = uicontrol('Parent',pcorrelation,'Style','pushbutton','FontSize',12,'String','Precedent','Position',[250 50 150 40],'ToolTipString', 'Permet de faire apparaitre la portion du signal Visuresp possèdant un coefficient de corrélation plus élevé','Callback',{@null}); %appeler fonction pour avoir correlation précédente
...
corr_thorax_text = uicontrol('Parent',pvaleur,'Style','text','FontSize',12,'String','Correlation Thorax :','Position',[5 305 140 25]);
corr_thorax_valeur = uicontrol('Parent',pvaleur,'Style','text','FontSize',12,'String',' ','Position',[150 305 120 25]);

corr_abdo_text = uicontrol('Parent',pvaleur,'Style','text','FontSize',12,'String','Correlation Abdominal :','Position',[3 255 170 25]);
corr_abdo_valeur = uicontrol('Parent',pvaleur,'Style','text','FontSize',12,'String',' ','Position',[180 255 120 25]);
